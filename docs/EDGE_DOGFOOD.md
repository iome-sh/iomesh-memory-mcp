...
| `ops_digest_export` | Local palace receipts for TUI `/memory digest` MCP fallback (#55/#66) · empty patterns OK · source-class diversity when mesh+private exist in-window · `source_hint=palace_timeline` · never invent mesh · dual_write OFF |
