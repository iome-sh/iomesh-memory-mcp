...
| HTTP unauthenticated on loopback | Residual | Loopback default; non-loopback requires shared secret before listen; `/healthz` and `/ready` stay open; bind localhost / proxy |
